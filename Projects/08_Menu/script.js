...
window.addEventListener('DOMContentLoaded', () => {
  ...
  btn_container.innerHTML = btnCategory;
...
function displayMenuItems(menuItems) {
  let display_menu = menuItems.map((item) => {
    return ` <div class="card_main">
  ...
  card_container.innerHTML = display_menu;
}
...
function displayButtons(btns) {
  btns.forEach((btn) => {
    btn.addEventListener('click', (e) => {
      ...
      const filterMenu = menu.filter((menuItems) => {
